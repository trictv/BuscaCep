...
namespace ServiceReference1
{
    ...
    public partial class AtendeClienteClient : System.ServiceModel.ClientBase<ServiceReference1.AtendeCliente>, ServiceReference1.AtendeCliente
    {
        ...
        public System.Threading.Tasks.Task<ServiceReference1.consultaCEPResponse> consultaCEPAsync(string cep, string usuario, string senha)
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.AtendeClientePort))
            {
                return new System.ServiceModel.EndpointAddress("https://apphom.correios.com.br/SigepMasterJPA/AtendeClienteService/AtendeCliente");
            }
            throw new System.InvalidOperationException(string.Format("Não foi possível encontrar o ponto de extremidade com o nome \'{0}\'.", endpointConfiguration));
        }
